...
int raft_end_snapshot(raft_server_t *me_)
{
    ...
    if (me->cb.persist_snapshot_metadata)
        me->cb.persist_snapshot_metadata(me_, me->udata, me->snapshot_last_idx, me->snapshot_last_term);
    ...
    int last_included_index)
{
    ...
    me->snapshot_last_idx = me->last_applied_idx;
